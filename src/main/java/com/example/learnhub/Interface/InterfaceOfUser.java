...
public interface InterfaceOfUser {
    ...
    UserDTO createAccount(String email, String fullName, MultipartFile image, String pass) throws IOException, com.example.learnhub.Exceptions.AppServiceExeption;
